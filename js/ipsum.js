...
//Create an array of words to randomize later
  var words_bob = ["cyber", "APT", "Hybrid solution", "synergy", "echo chamber", "dongle", "advanced detection", "blinky box", "crims"];
  var words_nobob = ["All in one solution", "java", "China", "0 day", "exploit", "RSA", "firewall", "anti virus", "NSA"];  
